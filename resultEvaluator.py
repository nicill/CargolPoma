...
"""
# Evaluate Hausdorff
python crownSegmenterEvaluator.py 0 BINARYGTMASK OUTPUTMASK >> $hausFile

# Evaluate matched percent
python crownSegmenterEvaluator.py 1 BINARYGTMASK OUTPUTMASK $roiMaskFileName epsilon >> $percentFile
python crownSegmenterEvaluator.py 1 OUTPUTMASK BINARYGTMASK $roiMaskFileName epsilon >> $reversePercentFile

# Evaluate number of points difference
python crownSegmenterEvaluator.py 2 BINARYGTMASK OUTPUTMASK epsilon >> $pointDiffFile

# Evaluate Euclidean
python crownSegmenterEvaluator.py 4 BINARYGTMASK OUTPUTMASK >> $eucFile

#euclidean matched
python crownSegmenterEvaluator.py 5 BINARYGTMASK OUTPUTMASK $roiMaskFileName epsilon >> $eucMatchedFile

#repeated count
python crownSegmenterEvaluator.py 6 BINARYGTMASK OUTPUTMASK $roiMaskFileName epsilon >> $repeatedFile
"""
